...
-- ----------------------------
BEGIN;
INSERT INTO `bus_goods` VALUES (1, '娃哈哈', 3, '武汉', '120ML', '瓶', 'PH12345', 'PZ1234', '小孩子都爱的', 2, 480, 10, '2020-02-24/99F329D96E06449E9A5D613B1D3FA7DD.jpg', 1);
...
INSERT INTO `bus_goods` VALUES (18, '八宝粥', 2, '广州', '箱', '15', 'DFS234341231', 'DF123124324', '粥', 4, 500, 600, '2020-03-07/5D1B185D310245A7AD7EFF51393C8432.jpg', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bus_sales` VALUES (1, 4, '支付宝', '2020-01-21 03:04:52', '落亦-', 8, '', 60.00, 1);
...
CREATE TABLE `sys_loginfo` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=308 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `sys_loginfo` VALUES (289, '超级管理员-system', '127.0.0.1', '2025-10-15 02:50:17');
INSERT INTO `sys_loginfo` VALUES (290, '超级管理员-system', '127.0.0.1', '2025-10-15 03:51:28');
INSERT INTO `sys_loginfo` VALUES (291, '超级管理员-system', '127.0.0.1', '2025-10-15 04:25:43');
INSERT INTO `sys_loginfo` VALUES (292, '超级管理员-system', '127.0.0.1', '2025-10-15 05:12:03');
INSERT INTO `sys_loginfo` VALUES (293, '超级管理员-system', '127.0.0.1', '2025-10-15 06:57:14');
INSERT INTO `sys_loginfo` VALUES (294, '超级管理员-system', '127.0.0.1', '2025-10-15 07:02:12');
INSERT INTO `sys_loginfo` VALUES (295, '超级管理员-system', '127.0.0.1', '2025-10-22 00:24:33');
INSERT INTO `sys_loginfo` VALUES (296, '超级管理员-system', '127.0.0.1', '2025-10-22 00:53:07');
INSERT INTO `sys_loginfo` VALUES (297, '超级管理员-system', '127.0.0.1', '2025-10-22 00:58:07');
INSERT INTO `sys_loginfo` VALUES (298, '超级管理员-system', '127.0.0.1', '2025-10-22 01:21:29');
INSERT INTO `sys_loginfo` VALUES (299, '超级管理员-system', '127.0.0.1', '2025-10-22 01:28:46');
INSERT INTO `sys_loginfo` VALUES (300, '超级管理员-system', '127.0.0.1', '2025-10-22 01:38:07');
INSERT INTO `sys_loginfo` VALUES (301, '超级管理员-system', '127.0.0.1', '2025-10-22 01:39:27');
INSERT INTO `sys_loginfo` VALUES (302, '超级管理员-system', '127.0.0.1', '2025-10-22 02:13:42');
INSERT INTO `sys_loginfo` VALUES (303, '超级管理员-system', '127.0.0.1', '2025-10-22 02:23:29');
INSERT INTO `sys_loginfo` VALUES (304, '超级管理员-system', '127.0.0.1', '2025-10-22 03:29:30');
INSERT INTO `sys_loginfo` VALUES (305, '超级管理员-system', '127.0.0.1', '2025-10-22 03:48:51');
INSERT INTO `sys_loginfo` VALUES (306, '超级管理员-system', '127.0.0.1', '2025-10-22 03:52:15');
INSERT INTO `sys_loginfo` VALUES (307, '超级管理员-system', '127.0.0.1', '2025-10-25 05:18:15');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_notice` VALUES (57, '紧急公告！！', 'test2', '2025-10-22 01:40:55', '超级管理员');
COMMIT;
...
INSERT INTO `sys_permission` VALUES (3, 1, 'menu', '进货管理', NULL, '&#xe645;', '', NULL, 1, 3, 1);
...
INSERT INTO `sys_permission` VALUES (30, 14, 'permission', '添加部门', 'dept:create', '', NULL, NULL, 1, 24, 1);
...
INSERT INTO `sys_permission` VALUES (82, 8, 'permission', '供应商添加', 'provider:create', NULL, NULL, NULL, 1, 74, 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, '超级管理员', 'system', '532ac00e86893901af5f0be6b704dbc7', '悉尼', 1, '超级管理员', 1, '2018-06-25 05:06:34', NULL, 1, 1, 0, '2025-10-22/513A6E254EFD4994A01459D969871A39.JPG', '04A93C74C8294AA09A8B974FD1F4ECBB');
...
INSERT INTO `sys_user` VALUES (3, '小李', 'liyuesu', '532ac00e86893901af5f0be6b704dbc7', '九江', 1, '否', 2, '2020-02-12 09:22:23', 5, 1, 3, 1, '2020-02-24/BF25CC186DA14E89BDA0FB061404E527.jpg', '04A93C74C8294AA09A8B974FD1F4ECBB');
